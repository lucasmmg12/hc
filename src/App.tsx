...
function App() {
  ...
  return (
    <div className="min-h-screen bg-gray-50" style={{ backgroundImage: 'url("/logogrow.png")', backgroundSize: 'cover', backgroundPosition: 'center', backgroundAttachment: 'fixed' }}>
