...
function App() {
  ...
  return (
    <div className="min-h-screen bg-gray-50" style={{ backgroundImage: 'url("/fondogrow2.png")', backgroundSize: 'cover', backgroundPosition: 'center', backgroundAttachment: 'fixed' }}>
